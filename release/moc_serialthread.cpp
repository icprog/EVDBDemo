...
static const char qt_meta_stringdata_SerialThread[] = {
    "SerialThread\0\0flag\0dbReadySignal(bool)\0"
    "type,arr\0dbSerialRptSignal(unsigned char,QByteArray)\0"
};
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->dbReadySignal((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->dbSerialRptSignal((*reinterpret_cast< unsigned char(*)>(_a[1])),(*reinterpret_cast< const QByteArray(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void SerialThread::dbReadySignal(bool _t1)
{
...
// SIGNAL 1
void SerialThread::dbSerialRptSignal(unsigned char _t1, const QByteArray & _t2)
{
