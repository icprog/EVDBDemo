#############################################################################
# Makefile for building: db_demo
# Generated by qmake (2.01a) (Qt 4.8.6) on: ??? ?? 10 09:19:30 2014
# Project:  db_demo.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe -spec c:\Qt\4.8.6\mkspecs\win32-g++ CONFIG+=release -o Makefile db_demo.pro
#############################################################################
...
Makefile: db_demo.pro  c:/Qt/4.8.6/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.6\mkspecs\win32-g++ CONFIG+=release -o Makefile db_demo.pro
